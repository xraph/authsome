...
export class AuthClient {
   ...
   */
  async updateOAuth2Client(clientId: string, body: UpdateOAuth2ClientRequest, token: string): Promise<UpdateClientResponse> {
   ...
   */
  async rotateOAuth2ClientSecret(clientId: string, token: string): Promise<RotateClientSecretResponse> {

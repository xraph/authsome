...
type ServiceInterface interface {
	...
	CreateSessionForUser(ctx context.Context, u *user.User, remember bool, ipAddress, userAgent string) (*AuthResponse, error)
	GetSession(ctx context.Context, token string) (*AuthResponse, error)

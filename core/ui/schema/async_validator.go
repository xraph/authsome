...
type AsyncValidatorFunc struct {
	name string
	fn   func(ctx context.Context, fieldID string, value any) error
}
...
func UniqueValidator(checkFn UniqueCheckFunc) AsyncValidator {
	return NewAsyncValidator("unique", func(ctx context.Context, fieldID string, value any) error {
		...
		if !isUnique {
			return errs.Conflict("this value is already taken")
		}
...
func ExternalAPIValidator(checkURL string, timeout time.Duration) AsyncValidator {
	...
	return NewAsyncValidator("external_api", func(ctx context.Context, fieldID string, value any) error {
...
func ExistsValidator(checkFn func(ctx context.Context, value any) (bool, error), entityName string) AsyncValidator {
	return NewAsyncValidator("exists", func(ctx context.Context, fieldID string, value any) error {
...
func NotExistsValidator(checkFn func(ctx context.Context, value any) (bool, error), message string) AsyncValidator {
	return NewAsyncValidator("not_exists", func(ctx context.Context, fieldID string, value any) error {
		exists, err := checkFn(ctx, value)
		if err != nil {
...
func ConditionalAsyncValidator(condition func(ctx context.Context, fieldID string, value any) bool, validator AsyncValidator) AsyncValidator {
	return NewAsyncValidator("conditional_"+validator.Name(), func(ctx context.Context, fieldID string, value any) error {
...
func RateLimitedValidator(validator AsyncValidator, maxRequests int, window time.Duration) AsyncValidator {
	...
	return NewAsyncValidator("rate_limited_"+validator.Name(), func(ctx context.Context, fieldID string, value any) error {
		...
		if tokens <= 0 {
			return errs.BadRequest("validation rate limit exceeded, please try again later")
		}
...
func TimeoutValidator(validator AsyncValidator, timeout time.Duration) AsyncValidator {
	return NewAsyncValidator("timeout_"+validator.Name(), func(ctx context.Context, fieldID string, value any) error {
		...
		case err := <-done:
			return err
		case <-ctx.Done():
			return errs.InternalServerErrorWithMessage("validation timed out")
		}
	})
}
...
func RetryValidator(validator AsyncValidator, maxRetries int, backoff time.Duration) AsyncValidator {
	return NewAsyncValidator("retry_"+validator.Name(), func(ctx context.Context, fieldID string, value any) error {
		var lastErr error
...
func CompositeAsyncValidator(validators ...AsyncValidator) AsyncValidator {
	return NewAsyncValidator("composite", func(ctx context.Context, fieldID string, value any) error {
...
func ParallelAsyncValidator(validators ...AsyncValidator) AsyncValidator {
	return NewAsyncValidator("parallel", func(ctx context.Context, fieldID string, value any) error {
		if len(validators) == 0 {
			return nil
		}
...
func CustomAsyncValidator(name string, message string, fn func(ctx context.Context, fieldID string, value any) bool) AsyncValidator {
	return NewAsyncValidator(name, func(ctx context.Context, fieldID string, value any) error {

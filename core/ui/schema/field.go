...
func (b *FieldBuilder) DefaultValue(value interface{}) *FieldBuilder {
...
func (b *FieldBuilder) DependsOn(fieldID string, value interface{}) *FieldBuilder {
...
func (b *FieldBuilder) HideWhen(fieldID string, value interface{}) *FieldBuilder {
	b.field.Conditions = append(b.field.Conditions, Condition{
		Field:    fieldID,
		Operator: ConditionEquals,
		Value:    value,
...
func (b *FieldBuilder) RequireWhen(fieldID string, value interface{}) *FieldBuilder {
	b.field.Conditions = append(b.field.Conditions, Condition{
		Field:    fieldID,
		Operator: ConditionEquals,
		Value:    value,
...
func (b *FieldBuilder) WithMetadata(key string, value interface{}) *FieldBuilder {
...
func (f *Field) GetDefaultValue() interface{} {

...
type AfterMemberAddHook func(ctx context.Context, member any) error
...
func (h *HookRegistry) ExecuteBeforeOrganizationCreate(ctx context.Context, req any) error {
	h.mu.RLock()
...
func (h *HookRegistry) ExecuteAfterOrganizationCreate(ctx context.Context, org any) error {
	h.mu.RLock()
...
func (h *HookRegistry) ExecuteAfterMemberAdd(ctx context.Context, member any) error {
	h.mu.RLock()
...
func (h *HookRegistry) ExecuteAfterOrganizationUpdate(ctx context.Context, org any) error {
	h.mu.RLock()
...
func (h *HookRegistry) ExecuteBeforeAppCreate(ctx context.Context, req any) error {
	h.mu.RLock()
...
func (h *HookRegistry) ExecuteAfterAppCreate(ctx context.Context, app any) error {
	h.mu.RLock()

...
// DeviceNotFound returns an error when a device is not found.
...
// DeviceCreationFailed returns an error when device creation fails.
...
// InvalidFingerprint returns an error when the device fingerprint is invalid.

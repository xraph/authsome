...
func (h *OrganizationHandler) CreateOrganization(c *forge.Context) error {
    if h.rl != nil {
        ...
        if err != nil || !ok { return c.JSON(429, map[string]string{"error": "rate limit exceeded"}) }
    }
    if !h.checkRBAC(c, "create", "organization:*", nil) { return c.JSON(403, map[string]string{"error": "forbidden"}) }
...
func (h *OrganizationHandler) GetOrganizations(c *forge.Context) error {
    ...
    if !h.checkRBAC(c, "read", "organization:*", nil) { return c.JSON(403, map[string]string{"error": "forbidden"}) }
    ...
    if idStr != "" {
        ...
        if !h.checkRBAC(c, "read", "organization:"+id.String(), &id) { return c.JSON(403, map[string]string{"error": "forbidden"}) }
...
func (h *OrganizationHandler) UpdateOrganization(c *forge.Context) error {
    ...
    if !h.checkRBAC(c, "update", "organization:"+body.ID.String(), &body.ID) { return c.JSON(403, map[string]string{"error": "forbidden"}) }
...
func (h *OrganizationHandler) UpdateOrganizationByID(c *forge.Context) error {
    ...
    if !h.checkRBAC(c, "update", "organization:"+id.String(), &id) { return c.JSON(403, map[string]string{"error": "forbidden"}) }
...
func (h *OrganizationHandler) DeleteOrganization(c *forge.Context) error {
    ...
    var body struct{ ID xid.ID `json:"id"` }
    if err := json.NewDecoder(c.Request().Body).Decode(&body); err != nil || body.ID.IsNil() {
        return c.JSON(400, map[string]string{"error": "invalid request"})
    }
    if !h.checkRBAC(c, "delete", "organization:"+body.ID.String(), &body.ID) { return c.JSON(403, map[string]string{"error": "forbidden"}) }
...
func (h *OrganizationHandler) DeleteOrganizationByID(c *forge.Context) error {
    ...
    if !h.checkRBAC(c, "delete", "organization:"+id.String(), &id) { return c.JSON(403, map[string]string{"error": "forbidden"}) }
...
func (h *OrganizationHandler) CreateMember(c *forge.Context) error {
    ...
    if !h.checkRBAC(c, "create", "member:*", &m.OrganizationID) { return c.JSON(403, map[string]string{"error": "forbidden"}) }
...
func (h *OrganizationHandler) GetMembers(c *forge.Context) error {
    ...
    if memberIDStr != "" {
        ...
        if !h.checkRBAC(c, "read", "member:"+memberID.String(), &m.OrganizationID) { return c.JSON(403, map[string]string{"error": "forbidden"}) }
        return c.JSON(200, m)
    }
    ...
    if !h.checkRBAC(c, "read", "member:*", &orgID) { return c.JSON(403, map[string]string{"error": "forbidden"}) }
    limit, _ := strconv.Atoi(q.Get("limit"))
    offset, _ := strconv.Atoi(q.Get("offset"))
...
func (h *OrganizationHandler) UpdateMember(c *forge.Context) error {
    ...
    if !h.checkRBAC(c, "update", "member:"+m.ID.String(), &m.OrganizationID) { return c.JSON(403, map[string]string{"error": "forbidden"}) }
...
func (h *OrganizationHandler) DeleteMember(c *forge.Context) error {
    ...
    if !h.checkRBAC(c, "delete", "member:"+body.ID.String(), &m.OrganizationID) { return c.JSON(403, map[string]string{"error": "forbidden"}) }
...
func (h *OrganizationHandler) CreateTeam(c *forge.Context) error {
    ...
    if !h.checkRBAC(c, "create", "team:*", &t.OrganizationID) { return c.JSON(403, map[string]string{"error": "forbidden"}) }
...
func (h *OrganizationHandler) GetTeams(c *forge.Context) error {
    ...
    if !h.checkRBAC(c, "read", "team:*", &orgID) { return c.JSON(403, map[string]string{"error": "forbidden"}) }
    q := c.Request().URL.Query()
    limit, _ := strconv.Atoi(q.Get("limit"))
    offset, _ := strconv.Atoi(q.Get("offset"))
...
func (h *OrganizationHandler) UpdateTeam(c *forge.Context) error {
    ...
    if !h.checkRBAC(c, "update", "team:"+t.ID.String(), &t.OrganizationID) { return c.JSON(403, map[string]string{"error": "forbidden"}) }
...
func (h *OrganizationHandler) DeleteTeam(c *forge.Context) error {
    ...
    if !h.checkRBAC(c, "delete", "team:"+body.ID.String(), &t.OrganizationID) { return c.JSON(403, map[string]string{"error": "forbidden"}) }
...
func (h *OrganizationHandler) AddTeamMember(c *forge.Context) error {
    ...
    if !h.checkRBAC(c, "update", "team:"+tm.TeamID.String(), &t.OrganizationID) { return c.JSON(403, map[string]string{"error": "forbidden"}) }
...
func (h *OrganizationHandler) RemoveTeamMember(c *forge.Context) error {
    ...
    if err != nil { return c.JSON(404, map[string]string{"error": err.Error()}) }
    if !h.checkRBAC(c, "update", "team:"+body.TeamID.String(), &t.OrganizationID) { return c.JSON(403, map[string]string{"error": "forbidden"}) }
...
func (h *OrganizationHandler) GetTeamMembers(c *forge.Context) error {
    ...
    if err != nil { return c.JSON(404, map[string]string{"error": err.Error()}) }
    if !h.checkRBAC(c, "read", "team:"+teamID.String(), &t.OrganizationID) { return c.JSON(403, map[string]string{"error": "forbidden"}) }
    q := c.Request().URL.Query()
    limit, _ := strconv.Atoi(q.Get("limit"))
    offset, _ := strconv.Atoi(q.Get("offset"))
...
func (h *OrganizationHandler) CreateInvitation(c *forge.Context) error {
    ...
    if !h.checkRBAC(c, "create", "invitation:*", &inv.OrganizationID) { return c.JSON(403, map[string]string{"error": "forbidden"}) }
...
func (h *OrganizationHandler) CreatePolicy(c *forge.Context) error {
    ...
    if !h.checkRBAC(c, "create", "policy:*", nil) { return c.JSON(403, map[string]string{"error": "forbidden"}) }
    if h.policyRepo == nil { return c.JSON(500, map[string]string{"error": "policy repository not configured"}) }
...
func (h *OrganizationHandler) GetPolicies(c *forge.Context) error {
    ...
    if !h.checkRBAC(c, "read", "policy:*", nil) { return c.JSON(403, map[string]string{"error": "forbidden"}) }
    if h.policyRepo == nil { return c.JSON(500, map[string]string{"error": "policy repository not configured"}) }
...
func (h *OrganizationHandler) DeletePolicy(c *forge.Context) error {
    ...
    if !h.checkRBAC(c, "delete", "policy:*", nil) { return c.JSON(403, map[string]string{"error": "forbidden"}) }
    if h.policyRepo == nil { return c.JSON(500, map[string]string{"error": "policy repository not configured"}) }
...
func (h *OrganizationHandler) UpdatePolicy(c *forge.Context) error {
    ...
    var body struct{ ID xid.ID `json:"id"`; Expression string `json:"expression"` }
    if err := json.NewDecoder(c.Request().Body).Decode(&body); err != nil || body.ID.IsNil() || strings.TrimSpace(body.Expression) == "" {
        return c.JSON(400, map[string]string{"error": "invalid request"})
    }
    if !h.checkRBAC(c, "update", "policy:*", nil) { return c.JSON(403, map[string]string{"error": "forbidden"}) }
    if h.policyRepo == nil { return c.JSON(500, map[string]string{"error": "policy repository not configured"}) }
...
func (h *OrganizationHandler) CreateRole(c *forge.Context) error {
    ...
    if !h.checkRBAC(c, "create", "role:*", orgPtr) { return c.JSON(403, map[string]string{"error": "forbidden"}) }
    var orgIDPtr *xid.ID
    if orgPtr != nil { orgIDPtr = orgPtr }
    role := &schema.Role{OrganizationID: orgIDPtr, Name: body.Name, Description: body.Description}
    if h.roleRepo == nil { return c.JSON(500, map[string]string{"error": "role repository not configured"}) }
...
func (h *OrganizationHandler) GetRoles(c *forge.Context) error {
    ...
    if orgIDStr != "" {
        ...
        if err != nil { return c.JSON(400, map[string]string{"error": "invalid org_id"}) }
        orgIDPtr = &id
        s := id.String()
        orgStrPtr = &s
    }
    if !h.checkRBAC(c, "read", "role:*", orgIDPtr) { return c.JSON(403, map[string]string{"error": "forbidden"}) }
    if h.roleRepo == nil { return c.JSON(500, map[string]string{"error": "role repository not configured"}) }
...
func (h *OrganizationHandler) AssignUserRole(c *forge.Context) error {
    ...
    if !h.checkRBAC(c, "update", "role:*", &body.OrganizationID) { return c.JSON(403, map[string]string{"error": "forbidden"}) }
...
func (h *OrganizationHandler) GetUserRoles(c *forge.Context) error {
    ...
    if userIDStr == "" { return c.JSON(400, map[string]string{"error": "user_id required"}) }
    userID, err := xid.FromString(userIDStr)
    if err != nil { return c.JSON(400, map[string]string{"error": "invalid user_id"}) }
    var orgPtr *xid.ID
    orgIDStr := q.Get("org_id")
    if orgIDStr != "" {
        id, err := xid.FromString(orgIDStr)
    ...
    if !h.checkRBAC(c, "read", "role:*", orgPtr) { return c.JSON(403, map[string]string{"error": "forbidden"}) }

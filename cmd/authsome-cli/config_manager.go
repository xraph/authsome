...
func (c *SimpleConfigManager) Get(key string) any {
	return c.v.Get(key)
}
...
func (c *SimpleConfigManager) Bind(key string, target any) error {
...
func (c *SimpleConfigManager) Set(key string, value any) {
	c.v.Set(key, value)
}

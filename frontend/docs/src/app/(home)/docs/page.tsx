  ...
  return (
    <main className="container flex flex-col flex-1 justify-center items-center py-16 text-center z-2">
      ...
      <div className="mt-8 grid grid-cols-1 gap-4 text-start md:grid-cols-2">
        {[
          {
            name: 'Authsome GoLang',
            description:
              'A pluggable authentication library for GoLang.',
            icon: <Building2 className="size-full" />,
            href: '/docs/go',
          },
          {
            name: 'Authsome Rust (Coming Soon)',
            description:
              'A pluggable authentication library for Rust.',
            icon: <Building2 className="size-full" />,
            href: '',
          },
          {
            name: 'Authsome UI',
            description: 'A pluggable authentication library for React / Vue.',
            icon: <Library className="size-full" />,
            href: '/docs/ui',
          },
          {
            name: 'Authsome CLI',
            description: 'A CLI tool for Authsome.',

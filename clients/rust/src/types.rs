...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct Config {
    #[serde(rename = "webhook_on_start")]
    pub webhook_on_start: bool,
    #[serde(rename = "cleanup_interval")]
    ...
    #[serde(rename = "require_permission")]
    ...
    #[serde(rename = "require_ticket")]
    pub require_ticket: bool,
    #[serde(rename = "auto_cleanup_enabled")]
    pub auto_cleanup_enabled: bool,
    #[serde(rename = "min_reason_length")]
    pub min_reason_length: i32,
    #[serde(rename = "show_indicator")]
    pub show_indicator: bool,
    #[serde(rename = "audit_all_actions")]
    pub audit_all_actions: bool,
    #[serde(rename = "impersonate_permission")]
    pub impersonate_permission: String,
    #[serde(rename = "min_duration_minutes")]
    pub min_duration_minutes: i32,
    #[serde(rename = "require_reason")]
    pub require_reason: bool,
    #[serde(rename = "webhook_on_end")]
    pub webhook_on_end: bool,
}

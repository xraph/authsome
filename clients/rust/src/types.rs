...
pub struct WebhookPayload {
    #[serde(rename = "", skip_serializing_if = "Option::is_none")]
    pub : Option<*ProviderCheckResult>,
}
...
pub struct StripeIdentityProvider {
    #[serde(rename = "", skip_serializing_if = "Option::is_none")]
    pub : Option<StripeIdentityConfig>,
}
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct SaveBuilderTemplate_req {
    #[serde(rename = "subject")]
    pub subject: String,
...
pub struct ContentEntryHandler {
    #[serde(rename = "", skip_serializing_if = "Option::is_none")]
    pub : Option<*service.ContentEntryService>,
}
...
pub struct AuditConfig {
    ...
    #[serde(rename = "enableAccessLog")]
    pub enable_access_log: bool,
    #[serde(rename = "logReads")]
    pub log_reads: bool,
    #[serde(rename = "logWrites")]
    pub log_writes: bool,
}
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct HandleUpdateSettings_updates {
}
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct Config {
    #[serde(rename = "ccpaEnabled")]
    pub ccpa_enabled: bool,
    #[serde(rename = "dataDeletion")]
    pub data_deletion: DataDeletionConfig,
    #[serde(rename = "dataExport")]
    pub data_export: DataExportConfig,
    #[serde(rename = "gdprEnabled")]
    pub gdpr_enabled: bool,
    #[serde(rename = "audit")]
    pub audit: ConsentAuditConfig,
    #[serde(rename = "cookieConsent")]
    pub cookie_consent: CookieConsentConfig,
    #[serde(rename = "dashboard")]
    pub dashboard: ConsentDashboardConfig,
    #[serde(rename = "enabled")]
    pub enabled: bool,
    #[serde(rename = "expiry")]
    pub expiry: ConsentExpiryConfig,
    #[serde(rename = "notifications")]
    pub notifications: ConsentNotificationsConfig,
}
...
pub struct MockOrganizationUIExtension {
    #[serde(rename = "", skip_serializing_if = "Option::is_none")]
    pub : Option<[]ui.OrganizationAction>,
}
...
pub struct ImpersonationMiddleware {
    #[serde(rename = "", skip_serializing_if = "Option::is_none")]
    pub : Option<*impersonation.Service>,
}
...
pub struct CheckDependencies {
    #[serde(rename = "", skip_serializing_if = "Option::is_none")]
    pub : Option<audit.OrganizationProvider>,
}

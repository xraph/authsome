...
func (p *Plugin) CreateUser(ctx context.Context) error {
	path := "/admin/users"
...
func (p *Plugin) DeleteUser(ctx context.Context, id xid.ID) error {
	path := "/admin/users/:id"
...
func (p *Plugin) BanUser(ctx context.Context, id xid.ID) error {
...
func (p *Plugin) UnbanUser(ctx context.Context, id xid.ID) error {
...
func (p *Plugin) ImpersonateUser(ctx context.Context, id xid.ID) error {
...
func (p *Plugin) SetUserRole(ctx context.Context, id xid.ID) error {
...
func (p *Plugin) RevokeSession(ctx context.Context, id xid.ID) error {

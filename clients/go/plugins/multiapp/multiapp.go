...
func (p *Plugin) RemoveMember(ctx context.Context, appId xid.ID, memberId xid.ID) error {
	path := "/apps/:appId/members/:memberId"
	err := p.client.Request(ctx, "DELETE", path, nil, nil, false)
	return err
}

// ListMembers ListMembers handles listing app members
func (p *Plugin) ListMembers(ctx context.Context, appId xid.ID) error {
...
func (p *Plugin) InviteMember(ctx context.Context, appId xid.ID) error {
	path := "/apps/:appId/members/invite"
	err := p.client.Request(ctx, "POST", path, nil, nil, false)
	return err
}

// UpdateMember UpdateMember handles updating a member in an organization
func (p *Plugin) UpdateMember(ctx context.Context, appId xid.ID, memberId xid.ID) error {
	path := "/apps/:appId/members/:memberId"
	err := p.client.Request(ctx, "PUT", path, nil, nil, false)
	return err
}
...
func (p *Plugin) CreateTeam(ctx context.Context, appId xid.ID) error {
	path := "/apps/:appId/teams"
	err := p.client.Request(ctx, "POST", path, nil, nil, false)
	return err
}

// GetTeam GetTeam handles team retrieval requests
func (p *Plugin) GetTeam(ctx context.Context, appId xid.ID, teamId xid.ID) error {
	path := "/apps/:appId/teams/:teamId"
	err := p.client.Request(ctx, "GET", path, nil, nil, false)
	return err
}

// UpdateTeam UpdateTeam handles team update requests
func (p *Plugin) UpdateTeam(ctx context.Context, appId xid.ID, teamId xid.ID) error {
	path := "/apps/:appId/teams/:teamId"
	err := p.client.Request(ctx, "PUT", path, nil, nil, false)
	return err
}
...
func (p *Plugin) DeleteTeam(ctx context.Context, teamId xid.ID, appId xid.ID) error {
	path := "/apps/:appId/teams/:teamId"
	err := p.client.Request(ctx, "DELETE", path, nil, nil, false)
	return err
}
...
func (p *Plugin) ListTeams(ctx context.Context, appId xid.ID) error {
	path := "/apps/:appId/teams"
	err := p.client.Request(ctx, "GET", path, nil, nil, false)
	return err
}
...
func (p *Plugin) AddTeamMember(ctx context.Context, req *authsome.AddTeamMemberRequest, appId xid.ID, teamId xid.ID) error {
	path := "/apps/:appId/teams/:teamId/members"
	err := p.client.Request(ctx, "POST", path, req, nil, false)
	return err
}

// RemoveTeamMember RemoveTeamMember handles removing a member from a team
func (p *Plugin) RemoveTeamMember(ctx context.Context, appId xid.ID, teamId xid.ID, memberId xid.ID) error {
	path := "/apps/:appId/teams/:teamId/members/:memberId"
	err := p.client.Request(ctx, "DELETE", path, nil, nil, false)
	return err
}

...
func init() {
	Migrations.MustRegister(func(ctx context.Context, db *bun.DB) error {
		...
		db.ExecContext(ctx, `ALTER TABLE permission_policies DROP CONSTRAINT IF EXISTS fk_permission_policies_user_organization_id;`)
		db.ExecContext(ctx, `ALTER TABLE permission_namespaces DROP CONSTRAINT IF EXISTS fk_permission_namespaces_app_id;`)
		db.ExecContext(ctx, `ALTER TABLE permission_namespaces DROP CONSTRAINT IF EXISTS fk_permission_namespaces_user_organization_id;`)
		db.ExecContext(ctx, `ALTER TABLE permission_audit_events DROP CONSTRAINT IF EXISTS fk_permission_audit_events_app_id;`)
		db.ExecContext(ctx, `ALTER TABLE permission_audit_events DROP CONSTRAINT IF EXISTS fk_permission_audit_events_user_organization_id;`)

		db.ExecContext(ctx, `DROP INDEX IF EXISTS idx_permission_policies_app_id;`)
		db.ExecContext(ctx, `DROP INDEX IF EXISTS idx_permission_policies_user_organization_id;`)
		...
		db.ExecContext(ctx, `DROP INDEX IF EXISTS idx_permission_namespaces_user_organization_id;`)
		db.ExecContext(ctx, `DROP INDEX IF EXISTS idx_permission_audit_events_app_id;`)
		db.ExecContext(ctx, `DROP INDEX IF EXISTS idx_permission_audit_events_user_organization_id;`)
		...
		db.ExecContext(ctx, `ALTER TABLE permission_policies DROP COLUMN app_id, DROP COLUMN user_organization_id;`)
		...
		db.ExecContext(ctx, `ALTER TABLE permission_namespaces DROP COLUMN app_id, DROP COLUMN user_organization_id;`)
		...
		db.ExecContext(ctx, `ALTER TABLE permission_audit_events DROP COLUMN app_id, DROP COLUMN user_organization_id;`)

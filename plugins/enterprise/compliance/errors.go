...
const (
	// CodeProfileNotFound is the error code for profile not found.
	...
	// CodeViolationNotFound is the error code for violation not found.
	...
	// CodeReportNotFound is the error code for report not found.
	...
	// CodeEvidenceNotFound is the error code for evidence not found.
	...
	// CodePolicyNotFound is the error code for policy not found.
	...
	// CodeMFARequired is the error code for MFA required.
	...
	// CodeNotAuthorized is the error code for not authorized.

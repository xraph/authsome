...
// DPoP accessors, so this stub still satisfies plugin.Engine after the DPoP
// methods joined the interface. Nothing in contributor discovery touches
// proof-of-possession, so they stay inert.
func (*registryEngine) RateLimiter() ratelimit.Limiter { return nil }

func (*registryEngine) DPoPValidator() *dpop.Validator                         { return nil }
func (*registryEngine) DPoPNonceSigner() *dpop.NonceSigner                     { return nil }
func (*registryEngine) DPoPModeForApp(context.Context, id.AppID) dpop.Mode     { return dpop.ModeOff }
func (*registryEngine) DPoPNonceRequiredForApp(context.Context, id.AppID) bool { return false }

...
func (s *Service) Enable(ctx context.Context, userID string, req *EnableRequest) (*TOTPSecret, error) {
    ...
    case "totp":
        ...
        if err := s.repo.UpsertSecret(ctx, uid, "totp", bundle.Secret, true); err != nil { return nil, err }
        return bundle, nil
    case "otp":
        if err := s.repo.UpsertSecret(ctx, uid, "otp", "", true); err != nil { return nil, err }
        return nil, nil
    default:
        return nil, nil
    }
...
func (s *Service) GenerateBackupCodes(ctx context.Context, userID string, count int) ([]string, error) {
    ...
    if err := s.repo.CreateBackupCodes(ctx, uid, hashes); err != nil { return nil, err }
    return codes, nil
}

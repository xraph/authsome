...
type SCIMConfig struct { //nolint:revive // stutter: cannot rename to Config; conflicts with plugin Config in config.go
...
// ProvisionLog records a single SCIM provisioning action for audit purposes.

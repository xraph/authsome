...
func GetAllOperators() []OperatorInfo {
	return []OperatorInfo{
		// Comparison operators
		{
			...
			Example:      "filter[_meta.status]=eq.published",
		...
		},
		{
			...
			Example:      "filter[_meta.status]=ne.draft",
			ApplicableTo: []string{"all"},
			ValueType:    "any",
		},
		{
		...
		// Array operators
		{
			...
			Example:      "filter[_meta.status]=in.(draft,review,published)",
			ApplicableTo: []string{"all"},
			ValueType:    "array",
		},
		{
			...
			Example:      "filter[_meta.status]=nin.(archived,deleted)",
			ApplicableTo: []string{"all"},
			ValueType:    "array",
		},
		{

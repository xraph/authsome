...
func TestHandleSend_Success(t *testing.T) {
	...
	req := httptest.NewRequest("POST", "/v1/auth/magic-link/send", body)
...
func TestHandleSend_InvalidJSON(t *testing.T) {
	...
	req := httptest.NewRequest("POST", "/v1/auth/magic-link/send", bytes.NewBufferString("not json"))
	req.Header.Set("Content-Type", "application/json")
	rec := httptest.NewRecorder()
	mux.ServeHTTP(rec, req)
...
func TestHandleVerify_Success(t *testing.T) {
	...
	req := httptest.NewRequest("POST", "/v1/auth/magic-link/verify", body)
	req.Header.Set("Content-Type", "application/json")
	rec := httptest.NewRecorder()
	mux.ServeHTTP(rec, req)
...
func TestHandleVerify_InvalidJSON(t *testing.T) {
	...
	req := httptest.NewRequest("POST", "/v1/auth/magic-link/verify", bytes.NewBufferString("not json"))
	req.Header.Set("Content-Type", "application/json")
	rec := httptest.NewRecorder()
	mux.ServeHTTP(rec, req)
